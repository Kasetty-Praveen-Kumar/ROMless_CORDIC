...
(
    ...
    /*  Pre-processing: 
            1. In Rotation mode:  Handle the sign of input data
    ...
    */
    ...
    assign w_i_quadrant[1] = (i_rm_vm)? (r_y1[DATA_WIDTH-1]) : 0;
    assign w_i_quadrant[0] = (i_rm_vm)? (r_y1[DATA_WIDTH-1] ^ r_x1[DATA_WIDTH-1]) : 0;
    ...
    reg [DATA_WIDTH-1 : 0] r_atan;
    always@(posedge i_clk) r_atan <= w_atan;
